---
doc_id: Appeal a Credit Decision Demo | Extenuating Circumstances | Federal Student
  Aid#1_0
domain: studentaid
title: Appeal a Credit Decision Demo | Extenuating Circumstances | Federal Student
  Aid
language: en
format: markdown
source_file: documents/markdown/studentaid_005.md
conversion_method: native
---

# Appeal a Credit Decision Demo | Extenuating Circumstances | Federal Student Aid

You're currently not logged in!

You must log in to your account to begin the credit appeal process.
...
Charged Off Account:&nbspAny account (open or closed) that has been charged off (written off) during the two years preceding the date of the credit report with a balance greater than zero.

Collection Account:&nbspAny account (open or closed) that has been placed in collection during the two years preceding the date of the credit report with a balance greater than zero.

90 or More Days Delinquent on any Debt:&nbspAny open account that is currently 90 or more days past due.
...
* *View Credit Check Details**

I have reviewed the information above and can provide documentation demonstrating my credit report is incorrect or demonstrating extenuating circumstances that justify my adverse credit history.

Email Address:

To update your Email Address, visit the "" page.
...
To update your Mobile Phone Number, visit the "" page.
...
We will send emails to the e-mail address you provided. To prevent our e-mails from going to your spam or junk mailbox, add StudentLoanSupport@ed.gov to your trusted senders list.
