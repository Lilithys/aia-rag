---
doc_id: Unpaid Refund Discharge | Federal Student Aid#1_0
domain: studentaid
title: Unpaid Refund Discharge | Federal Student Aid
language: en
format: markdown
source_file: documents/markdown/studentaid_091.md
conversion_method: native
---

# Unpaid Refund Discharge | Federal Student Aid
...
If you re ready to apply for the unpaid refund discharge, you must complete the *Loan Discharge Application: Unpaid Refund* and send the completed form to your loan servicer.
...
Yes, if your child withdrew from school but the school didn t make a required return of your parent PLUS loan funds, the amount of the loan that the school should have returned will be discharged. Contact your loan servicer for more information.
