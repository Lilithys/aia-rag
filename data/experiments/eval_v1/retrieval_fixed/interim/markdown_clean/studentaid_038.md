---
doc_id: Gainful Employment | Federal Student Aid#1_0
domain: studentaid
title: Gainful Employment | Federal Student Aid
language: en
format: markdown
source_file: documents/markdown/studentaid_038.md
conversion_method: native
---

# Gainful Employment | Federal Student Aid
...
On April 25, 2018, program appeal status information was updated to reflect decisions made to date; some appeals remain subject to review and, consequently, no decisions have been made. Appeals classified as abandoned represent those instances in which a school submitted a notice of intent to appeal but did not subsequently submit required information by the deadline. Appeals classified as approved are instances in which the schools met the requirements for the U.S. Department of Education to grant the program appeals. As of April 25, 2018, no appeals that have been reviewed have been denied. On the spreadsheet, a single asterisk (*) indicates that the information presented in the field has changed from what was presented prior to the April 25, 2018, update. A double asterisk (**) indicates that the program rates were recalculated after the final rates were issued to correct for errors in the data reported to the NSLDS database.

- Glossary of Terms used in the D/E data spreadsheet
- Download the Debt to Earnings data spreadsheet
...
- Download the GE program earnings data.
...
- 2011 Gainful Employment Informational Rate Downloadable Spreadsheet
