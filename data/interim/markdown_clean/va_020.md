...
domain: va
title: VA Dental Care | Veterans Affairs#1
language: en
format: markdown
source_file: documents/markdown/va_020.md
...
- Are signed up for our Civilian Health and Medical Program (also called CHAMPVA, a health insurance program for dependents of Veterans).Find out if you can sign up for CHAMPVA
