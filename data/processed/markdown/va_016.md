...
domain: va
title: Traumatic Injury Protection (TSGLI) | Veterans Affairs#1
language: en
format: docx
source_file: documents/docx/va_016.docx
conversion_method: docx-styles
---

# Traumatic Injury Protection (TSGLI) | Veterans Affairs
...
Note: We ve removed the previous requirement that you must have been injured during Operations Enduring or Iraqi Freedom (OEF or OIF). Find out if you qualify for retroactive benefits
...
To get payments including retroactive TSGLI payments you ll need to apply. To file a claim, fill out the Application for TSGLI Benefits (SGLV 8600), and fax, email, or mail it to us. Look for the address of your service branch on the front page of the form.Download the Application for TSGLI Benefits (PDF)
...
If your letter says to complete this form, fill it out and submit it to your branch of service.Download the TSGLI Appeal Request Form (PDF)
